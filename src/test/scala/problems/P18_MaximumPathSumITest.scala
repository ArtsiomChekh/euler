...
class P18_MaximumPathSumITest extends FunSuite:

  val triangleTest1: Array[Array[Int]] = Array(
    Array(3),
    Array(7, 4),
    Array(2, 4, 6),
    Array(8, 5, 9, 3)
  ...
  val triangleTest2: Array[Array[Int]] = Array(
    Array(75),
    Array(95, 64),
    Array(17, 47, 82),
    Array(18, 35, 87, 10),
  ...
  import P18_MaximumPathSumI._

  test("maxPathSum in triangleTest1"):
    assertEquals(maxPathSum(triangleTest1), 23)

  test("maxPathSum in triangleTest2"):
    assertEquals(maxPathSum(triangleTest2), 1074)
